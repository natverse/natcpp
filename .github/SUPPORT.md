# Getting help with natcpp

Thanks for using natcpp. We're sorry if you're having trouble, but don't worry,
...
* Search GitHub for [_issues_ with the natcpp package](https://github.com/natverse/natcpp/issues).
...
* If you need to report a *new* bug:
  please [file an issue](https://github.com/natverse/natcpp/issues/new).
* If you're not sure:
